...
cmd_path = "/srv/dune/data/users/dunepro/cache/data-mgmt-testing/ESClient/rucio_es_client.py"
...
cmd_args = f"-E {end_point} -D /srv/dune/data/users/dunepro/cache/rucio_es_cache --simultaneous-days 4 --debug-level 3 --search-size 10000 --show-timing"
