...
router.get("/", function (req, res, next) {
  ...
  runPython(function () {
    ...
    fs.readFile(`${process.cwd()}/cached_searches/fails_M${req.query.searchMode}_${req.query.startDate.replaceAll("/","_")}_to_${req.query.endDate.replaceAll("/","_")}.json`, "utf8", (err, data) => {
